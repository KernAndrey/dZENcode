...
class NewComment(forms.Form):
    user_name = forms.CharField(max_length=30, required=True, label="User Name", widget=forms.TextInput(attrs={'class': 'form-control'}))
    email = forms.EmailField(max_length=50, required=True, label="E-mail", widget=forms.TextInput(attrs={'class': 'form-control'}))
